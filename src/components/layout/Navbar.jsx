  ...
  return (
    <>
      ...
      <div className="w-full fixed h-20 flex justify-between items-center top-0 px-8 z-40 font-medium">
        <Link href="/" className="font-bold px-3 py-1 bg-bg rounded-[45] text-lg">VITTA</Link>
        ...
        <div className="flex gap-x-2 justify-center items-center">
          <button
            ...
            className="text-xl md:hidden p-2 bg-bg rounded-full"
          >
            <FaAlignRight />
          </button>
          <Link className="hidden px-3 bg-bg rounded-[45] md:flex" href="/#contact">
