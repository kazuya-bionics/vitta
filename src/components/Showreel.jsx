  ...
  return (
    <div className='w-full h-screen relative overflow-hidden'>
      ...
      <div className='w-full h-full flex flex-col relative justify-center items-center'>
        ...
        <div className="flex flex-col justify-center items-center z-10 text-white font-bold text-center text-6xl">
          <h3>ARE YOU NOT FULLY</h3>
          <div className="flex justify-center items-center gap-x-4 bg-black py-1 px-20">
            <p className="text-brand text-xl">TOUCH PLAY</p>
            <FaPlayCircle className="border p-2 rounded-full text-5xl font-normal animate-pulse"/>
          </div>
          <h3>CONVENCED?</h3>
        </div>
