...
export const About = () => {
  return (
    <section id='nosotros' className="w-full h-screen overflow-hidden relative">
      ...
      <div className='w-full h-[90vh] md:h-[87vh] bg-[#F2F5FF] flex flex-col justify-center md:items-start px-8 md:px-16 gap-y-4 md:gap-y-2 md:text-left'>
        ...
        <a className="bg-blue-700 text-white px-6 py-3 rounded-lg mt-8 hover:bg-blue-800 transition-colors text-center" href="#showreel">Ver proyectos</a>
      </div>
