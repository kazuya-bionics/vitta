  ...
  return (
    <motion.div className="size-full bg-radial from-[#ACBFF7] to-[#0032CA] w-full h-screen overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-28 left-[50%] translate-x-[-50%] md:translate-x-0 md:left-16 md:top-[50%] md:translate-y-[-50%] text-4xl md:text-7xl font-bold z-10">
        <h3 className="text-white text-center">VALTEMIA</h3>
      </motion.div>
      <motion.div 
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <h3 className="text-white text-center">GROUP</h3>
      </motion.div>
